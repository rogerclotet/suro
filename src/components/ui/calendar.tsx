  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground rounded-md [&_.event-indicator]:bg-background",
        day_today:
          "bg-secondary text-secondary-foreground [&_.event-indicator]:bg-background",
        day_outside:
