...
//
// Keep in sync with `apps/web/src/lib/feedback-survey.ts`.
...
// survey's single-choice question matches its configured choices.
...
export const FEEDBACK_SECTIONS = Object.keys(
